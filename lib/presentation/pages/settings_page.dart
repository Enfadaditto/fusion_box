                              ...
                              if (state is SettingsLoaded) {
                                return Column(
                                  children: [
                                    ...
                                    SwitchListTile(
                                      title: const Text(
                                        'Autogenerated Sprites',
                                        style: TextStyle(
                                          fontWeight: FontWeight.w500,
                                        ),
                                      ),
                                      subtitle: const Text(
                                        'Show auto-generated sprites when no custom sprite exists',
                                        style: TextStyle(
                                          fontSize: 12,
                                          color: Colors.grey,
                                        ),
                                      ),
                                      value: state.useAutogenSprites,
                                      onChanged: (value) {
                                        context.read<SettingsBloc>().add(
                                          ToggleAutogenSprites(value),
                                        );
                                      },
                                      contentPadding: const EdgeInsets.only(
                                        left: 0,
                                      ...
                                      secondary: Icon(
                                        state.useAutogenSprites ? Icons.auto_awesome : Icons.block,
                                        color: state.useAutogenSprites ? Colors.purple : Colors.grey,
                                      ),
                                    ),
                                    const SizedBox(height: 16),
                                    SwitchListTile(
